// https://img.shields.io/badge/ReadMeGen-v1.0-green
...
const questions = [
  ...
  },
  {
    type: "input",
    name: "tests",
    message: "Do you have any tests for your application? If so provide how to run it",
  },
  {
    type: "input",
    name: "username",
...
function init() {
  ...
  .then(function ({ title, description, installation, usage, license, contribution, tests, username, email, credits }) {
    ...
    .then(function(userInputObj){
        axios.get(userInputObj.queryUrl).then(function (res) {
